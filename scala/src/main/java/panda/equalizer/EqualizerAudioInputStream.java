...
public class EqualizerAudioInputStream extends AudioInputStream {
    private EqualizerInputStream eq;
    ...
    public EqualizerAudioInputStream(AudioInputStream stream, int bands) {
        ...
        eq = new EqualizerInputStream(stream, format.getSampleRate(), format.getChannels(), format.getEncoding().equals(AudioFormat.Encoding.PCM_SIGNED), format.getSampleSizeInBits(), format.isBigEndian(), bands);
    }
    ...
    public static boolean isParamsSupported(AudioFormat format, int bands) {
        if (!format.getEncoding().equals(AudioFormat.Encoding.PCM_SIGNED) && !!format.getEncoding().equals(AudioFormat.Encoding.PCM_UNSIGNED))
            return false;
        return EqualizerInputStream.isParamsSupported(format.getSampleRate(), format.getChannels(), format.getSampleSizeInBits(), bands);
    }
